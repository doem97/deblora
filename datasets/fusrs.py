...
class FUSRS(LT_Dataset):
    classnames_txt = "./datasets/FUSRS/classnames.txt"
    train_txt = "./datasets/FUSRS/train.txt"
    test_txt = "./datasets/FUSRS/test.txt"
    split_config = "./datasets/FUSRS/lt_split_config.yaml"
