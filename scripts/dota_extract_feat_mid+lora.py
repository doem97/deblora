...
from src.models.dift_sd_lora import SDMidFeatExtractLoRA
...
def main(args):
    ...
    dift = SDMidFeatExtractLoRA(sd_id=args.sd_id, cat_list=DOTAV1_CAT_LIST, prompt_template=args.prompt_template, lora_path=args.lora_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_path", type=str, required=True, help="Path to the LoRA model for feature extraction.")
