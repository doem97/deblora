...
def main(args):
    ...
    for category in os.listdir(args.input_path):
        dift = SDFeaturizer4Eval(sd_id=args.sd_id, cat_list=["cargo", "fishing", "container", "tanker"], prompt_prefix=args.prompt_prefix, lora_path=args.lora_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_path", type=str, default=None, help="Path to the LoRA model.")
